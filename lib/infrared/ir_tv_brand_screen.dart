...
List<IrTvRemote> allRemotes = [samsungIRRemote, lgIRRemote];

class IrTvBrandScreen extends StatelessWidget {
  const IrTvBrandScreen({super.key});
        ...
        children: [
          ...
          Expanded(
            child: ListView.builder(
              shrinkWrap: true,
              itemCount: allRemotes.length,
              itemBuilder: (context, index) {
                IrTvRemote selectedRemote = allRemotes[index];
                return ListTile(
